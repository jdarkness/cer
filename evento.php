...
<body>
  ...
  <?php  
   ...
   <table id="registros">
	...
	<td class="alinear_centro" onclick="enviar_accion('editar','<?php echo $row['IdEvento'];?>');"><?php echo $i+1; ?></td>
    <td onclick="enviar_accion('editar','<?php echo $row['IdEvento'];?>');"><?php echo $row['NombreLargo'];?></td>
    <td onclick="enviar_accion('editar','<?php echo $row['IdEvento'];?>');"><?php echo $row['NombreCorto'];?></td>
    <td onclick="enviar_accion('editar','<?php echo $row['IdEvento'];?>');"><?php echo $row['Descripcion'];?></td>
	<td>		
		<div class="acciones">
